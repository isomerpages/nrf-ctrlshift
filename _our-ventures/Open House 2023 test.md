---
title: Open House 2023 test
permalink: /our-ventures/test/
description: ""
---
```
<style>
            @font-face {
                ...
                src: url("https://dstnct-dev.com/ctrl-shift/wp-content/themes/ctrlshift/fonts/din_alternate_bold-webfont.woff2")
                        format("woff2"),
                    url("https://dstnct-dev.com/ctrl-shift/wp-content/themes/ctrlshift/fonts/din_alternate_bold-webfont.woff")
                        format("woff");
                font-weight: normal;
                font-style: normal;
            }
    ...
    z-index: -1;
            ...
            .form-group-contact label.error:before {
                ...
                width: 18px;
                height: 18px;
                background: url(https://dstnct-dev.com/ctrl-shift/wp-content/themes/ctrlshift/img/icon-error.svg) no-repeat center;
                background-size: contain;
            }
            .subject-hidden {
                margin-top: -40px;
            ...
            *,
            ...
            .item-button-trail a:hover img {
                animation: Rocket 1s infinite;
                -webkit-animation: Rocket 1s forwards;
            }
            .item-button-truck a:hover img {
                animation: Truck 1s ease-in-out infinite;
                -webkit-animation: Truck 1s ease-in-out infinite;
            }
            .item-button-find-out-more
                a:hover
                .container-caret
                svg:first-child {
                animation: Rotate 1s 0s forwards;
                -webkit-animation: Rotate 1s 0s forwards;
            }
            .item-button-find-out-more
                a:hover
                .container-caret
                svg:nth-child(2) {
                animation: Rotate 1s 0.1s forwards;
                -webkit-animation: Rotate 1s 0.1s forwards;
            }
            .item-button-find-out-more
                a:hover
                .container-caret
                svg:nth-child(3) {
                animation: Rotate 1s 0.2s forwards;
                -webkit-animation: Rotate 1s 0.2s forwards;
            }
            .btn-rounded:focus,
            .btn-rounded-white:focus,
            .btn-rounded-yellow:focus {
                animation: pressButton 0.1s forwards;
                -webkit-animation: pressButton 0.1s forwards;
                position: relative;
            }

            .btn-rounded:focus ~ .shadow-button,
            .btn-rounded-white:focus ~ .shadow-button,
            .btn-rounded-yellow:focus ~ .shadow-button {
                animation: pressButton 0.1s forwards;
                -webkit-animation: pressButton 0.1s forwards;
            }
...
<nav class="nav-white wrapper-top-nav">
        ...
        </nav><section id="header-truck" class="header-nav-white bg-blue-grid">
            <div class="container">
                <div class="col-12">
                    ...
                    <div class="map-truck p-relative">
                            ...
                            <div class="rotateFloatTruck1">
                                <div class="counterrotateFloatTruck1">
                                    <div class="innerFloatTruck1">
                                        <img
                                            src="https://dstnct-dev.com/ctrl-shift/wp-content/themes/ctrlshift/img/float-map-truck-1.svg"
                                            alt="truck"
                                            class="FloatTruck1"
                                        />
                                    </div>
                        ...
                        <img
                            src="https://dstnct-dev.com/ctrl-shift/wp-content/themes/ctrlshift/img/map-truck.svg"
                            alt="map truck"
                            class="d-none d-lg-block"
                        />
                        <img
                            src="https://dstnct-dev.com/ctrl-shift/wp-content/themes/ctrlshift/img/map-truck-mobile.svg"
                            alt="map truck"
                            class="d-lg-none img-full"
                        />
                        <div class="outCircleFloatTruck2">
                            <div class="rotateFloatTruck2">
                                <div class="counterrotateFloatTruck2">
                                    <div class="innerFloatTruck2">
                                        <img
                                            src="https://dstnct-dev.com/ctrl-shift/wp-content/themes/ctrlshift/img/float-map-truck-2.svg"
                                            alt="truck"
                                            class="FloatTruck2"
                                        />
                                    </div>
                            ...
                            <div class="rotate">
                                <div class="counterrotateFloatTruck3">
                                    <div class="innerFloatTruck3">
                                        <img
                                            src="https://dstnct-dev.com/ctrl-shift/wp-content/themes/ctrlshift/img/float-map-truck-3.svg"
                                            alt="truck"
                                            class="FloatTruck3"
                                        />
                                    </div>
                            ...
                            <div class="rotate">
                                <div class="counterrotateFloatTruck4">
                                    <div class="innerFloatTruck4">
                                        <img
                                            src="https://dstnct-dev.com/ctrl-shift/wp-content/themes/ctrlshift/img/float-map-truck-4.svg"
                                            alt="truck"
                                            class="FloatTruck4"
                                        />
                                    </div>
                        ...
                        <div class="popup-truck popup-truck-1 expanded">
                            <div class="title-popup">
                                ...
                                <div class="arrow-popup-truck">
                                    <img
                                        src="https://dstnct-dev.com/ctrl-shift/wp-content/themes/ctrlshift/img/caret-right-green.svg"
                        ...
                        <div class="popup-truck popup-truck-2 expanded">
                            <div class="title-popup">
                                ...
                                <div class="arrow-popup-truck">
                                    <img
                                        src="https://dstnct-dev.com/ctrl-shift/wp-content/themes/ctrlshift/img/caret-right-blue.svg"
                                        alt="caret right"/>
                                    <img
                                        src="https://dstnct-dev.com/ctrl-shift/wp-content/themes/ctrlshift/img/caret-right-blue.svg"
                                        alt="caret right"/>
                        ...
                        <div class="popup-truck popup-truck-3 expanded">
                            <div class="title-popup">
                                ...
                                <div class="arrow-popup-truck">
                                    <img
                                        src="https://dstnct-dev.com/ctrl-shift/wp-content/themes/ctrlshift/img/caret-right-yellow.svg"
                                        alt="caret right"/>
                                    <img
                                        src="https://dstnct-dev.com/ctrl-shift/wp-content/themes/ctrlshift/img/caret-right-yellow.svg"
                                        alt="caret right"/>
                    ...
                    <div class="col-12">
                        <div class="text-center">
                            <h1 class="title-section text-white">
                                Here’s how <br class="d-md-none" />
                                you can get one too!
                            </h1>
                        </div>
                    </div>
                </div>
                <div class="row row-reverse py5">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <img src="https://dstnct-dev.com/ctrl-shift/wp-content/themes/ctrlshift/img/img-truck-1.png" alt="img truck" />
                    </div>
                </div>
                <div class="row py-5">
                    <div class="col-lg-6">
