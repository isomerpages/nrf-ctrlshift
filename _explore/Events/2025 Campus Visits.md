...
permalink: /explore/events/2025-campus-visits/
variant: markdown
description: ""
...
<style>
    ...
    *,
    ...
    .item-button-find-out-more a:hover .container-caret svg:first-child {
        animation: Rotate 1s 0s forwards;
        -webkit-animation: Rotate 1s 0s forwards;
    }

    .item-button-find-out-more a:hover .container-caret svg:nth-child(2) {
        animation: Rotate 1s 0.1s forwards;
        -webkit-animation: Rotate 1s 0.1s forwards;
    }

    .item-button-find-out-more a:hover .container-caret svg:nth-child(3) {
                    ...
                    <div class="rotate">
                        <div class="counterrotateFloatTruck4">
                            <div class="innerFloatTruck4">
                                <img src="/images/2025%20Campus%20Visit/Robotics_hand.png" alt="truck" class="FloatTruck4">
                            </div>
                        </div>
                    </div>
                </div>
