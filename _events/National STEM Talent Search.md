...
.section-2-text-box .icon-2position: absolute;bottom: -30px;height: 60px;width: 60px;left: 25%;}
.section-2-text-box .icon-3osition: absolute;bottom: -30px;height: 60px;width: 60px;left: 25%;}
