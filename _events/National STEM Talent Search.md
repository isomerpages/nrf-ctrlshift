		...
		<div class="row mb-5 stem-row-1" style="">
			...
			<div class="col-sm-8 section-2-row-1 desktop-only">
				<div class="img-pull-left">
					...
					<img style="position: absolute;bottom: -30px;height: 60px;width: 60px;left: 25%;" class="icon-2" alt="National STEM Talent Search Img 1" src="https://raw.githubusercontent.com/isomerpages/psd-ste-whats-next/staging/images/National%20STEM%20Talent%20Search/icon-saturn.png">
