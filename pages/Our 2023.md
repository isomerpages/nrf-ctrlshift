...
<style>
	...
	.bg-blue-grid{background: #0037cc url(https://raw.githubusercontent.com/isomerpages/psd-ste-whats-next/staging/images/map-mobile-new.png?sanitize=true) no-repeat;background-size: cover;}
	}
        </style>
<section id="header-truck" class="header-nav-white bg-blue-grid">
            <div class="container" style="position: relative">
                ...
                <img
                src="https://raw.githubusercontent.com/isomerpages/psd-ste-whats-next/staging/images/desktop-map-image.png"
                alt="map truck"
