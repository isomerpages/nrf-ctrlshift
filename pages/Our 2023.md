...
<style>
	...
	.bg-blue-grid{background: #0037cc url(https://raw.githubusercontent.com/isomerpages/psd-ste-whats-next/staging/images/map-mobile-new.png?sanitize=true) no-repeat center;background-size: cover;}
	}
        </style>
