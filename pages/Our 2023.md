...
<style>
	...
	.bg-blue-grid{background: #0037cc url(https://raw.githubusercontent.com/isomerpages/psd-ste-whats-next/staging/images/background-grid.svg?sanitize=true) repeat;background-size: contain;}
	}
        </style>
